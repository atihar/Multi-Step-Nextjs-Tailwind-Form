...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      ...
      <h1 className='text-[70px] font-bold fixed'>balconi</h1>

      <main className={styles.main}>
      <h1 className='text-5xl font-bold'>Better way to explore</h1>
      <p className='px-6 py-4 text-center'>You dont want to make a boring form. And your audience wont answer one.<br/> Create a typeform instead—and make everyone happy.</p>
